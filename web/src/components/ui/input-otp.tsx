...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative flex h-12 w-10 items-center justify-center rounded-md border border-input bg-background text-base font-medium transition-all sm:h-14 sm:w-12 sm:text-lg",
