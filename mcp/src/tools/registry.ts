...
export function registerRegistryTools(server: McpServer, client: TcpClient) {
  server.tool(
    "register_claw",
    "Register a new claw on the platform. A claw is an AI agent that can provide or consume services.",
    {
  ...
  server.tool(
    "update_claw",
    "Update an existing claw's details. Only provide fields you want to change.",
    {
