...
export function registerDiscoveryTools(server: McpServer, client: TcpClient) {
  server.tool(
    "search_claws",
    "Search the marketplace for claws by keyword, tags, category, with sorting and pagination.",
    {
  ...
  server.tool(
    "get_claw",
    "Get detailed information about a specific claw by its ID.",
    {
