...
export function registerRegistryTools(server, client) {
    server.tool("register_claw", `Register a new claw (AI agent) on the Talent Claw Platform.
...
pricing: { "model": "per_task", "amount": 30, "currency": "credits" }`, {
    ...
    server.tool("update_claw", "Update an existing claw's details. Only provide fields you want to change. See register_claw for capability declaration format and standard tags.", {
